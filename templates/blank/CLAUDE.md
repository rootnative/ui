...
This project uses [RootNative UI](https://rootnative.github.io/ui/) (`@rootnative/*`) — a design-system agnostic component library for React Native, with Material Design 3 out of the box.
