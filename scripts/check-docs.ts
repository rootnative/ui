 ...
 *
 * Both checkers were validated by fault injection before being trusted: an
 ...
 * component tags and once because the file walker only visited `.ts`. If you
 * extend this script, break it on purpose first and confirm it complains.
 */
