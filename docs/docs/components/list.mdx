---
sidebar_position: 4
description: Lists are continuous, vertical indexes of text and images. Follows the Material Design 3 Lists specification.
---
...
Use `insetStart` to align the divider with text that follows a leading icon:
...
`ListDivider` is an alias of the standalone [Divider](./divider.mdx) component and
takes the same props. New code should import `Divider` directly.
