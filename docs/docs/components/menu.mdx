...
around. Horizontally, the menu shifts back inside the screen margin rather than flipping. When
neither side has room for the whole menu, it caps at the available height and scrolls.
