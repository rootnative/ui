---
sidebar_position: 4
description: Menus show a list of choices on a temporary surface, anchored to the control that opened them.
---
...
- The surface reports `role="menu"` and items report `role="menuitem"`.
